...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            {{-- <form action="/products/store " id="frm" method="POST" enctype="multipart/form-data"> --}}
                @csrf
                @if ($errors->any())
                ...
                <font id="title_error" color="red"></font>
                <label for="description">Description</label>
                <br>
                <font id="description_error" color="red"></font>
                ...
                <font id="price_error" color="red"></font>
                <br>
               ...
               <br>
               <font id="subcategory_error" color="red"></font>
               <br>
               <br>
...
<script>
    ...
    function addProduct()
    {
        ...
        // if(title=='')
        // {
        //     $('#title_error').html("Enter a valid Title");
        // }
        // else
        // {
        //     $('#title_error').hide();
        ...
        // if(price=='')
        // {
        //     $('#price_error').html("Enter a Price");
        // }
        // else
        // {
        //     $('#price_error').hide();
        ...
        // if(subcategory=='')
        // {
        //     $('#subcategory_error').html("Select a subcategory");
        // }
        // else
        // {
    ...
    Swal.fire({
            ...
            .then((willDelete) => {
            if (willDelete.isConfirmed)     // checking if the deletion is finally confirmed to avoid accidental occurance...
            {
                $.ajax({
                type:"GET",
                dataType:'json',
